package com.vincent.pmsdemo.common.generator;
...
public class CodeGenerator {
    // 数据库 URL
    private static final String URL = "jdbc:mysql://172.16.9.38:23306/zentao?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    // 数据库用户名
    private static final String USERNAME = "selectuser";
    // 数据库密码
    private static final String PASSWORD = "lAHE5#oG^Jsh>#d%";
    // @author 值
    private static final String AUTHOR = "vincent";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.vincent.pmsdemo";
    // xml文件路径
